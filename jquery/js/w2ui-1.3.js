...
(function ($) {
	...
	$.extend(w2field, {
			...
			return $(this).each(function (field, index) {
				...
				switch (tp) {
					...
					case 'upload':
						...
						this.filedata = []; //hold the files in an array object
		...
		upload_add: function (file) {
			...
			obj.filedata.push(file); //add the file to the file object
			// read file as base64
		...
		//upload the files using jQuery ajax to the url specified in the settings
		upload_upload: function (obj, callback, extraparams){
		    ...
		    console.log('ERROR: Cannot upload file, URL is empty?');      
      	  }
